...
int main(){
    ...
    */
    ...
    /// array of 4 pointer to function, which accepts two integers and return integer
    int (* arfunptr[4]) (int, int);
    printf("\nSize of arfunptr : %d",sizeof(arfunptr));
    arfunptr[0] = addi;
    arfunptr[1] = addi;
    arfunptr[2] = addi;
    arfunptr[3] = addi;
    printf("\nSize of arfunptr : %d",sizeof(arfunptr));
    int yy = arfunptr[0](1, 2);
    printf("\nAddition : %d",yy);

    printf("\n-------------------------------------------------------\n");

    void (* complex1(int , void (*pfn)(int)) ) (int);
